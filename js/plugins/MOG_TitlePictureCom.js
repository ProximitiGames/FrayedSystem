...
/*:
 * @plugindesc (v1.5 *) Adiciona comandos em imagens no lugar da janela.
 * @author Moghunter
 * 
 * @param -> Main <<<<<<<<<<<<<<<<<<<<<<<
 * @desc
 ...
 * @help  
 * =============================================================================
 * +++ MOG - Title Picture Commands (v1.5) +++
 * By Moghunter 
 ...
 * - (NEW) - Adicionado o efeito do comando tremer.
 * - (NEW) - Adicionado a função de apresemtar as imagens de fundo dependendo 
 *           da seleção de comando.
 */
